...
if __name__ == "__main__" :
    ...
    xspec.AllData(f"1:1 {'stx_spectrum_20220723_122031.fits'}{{1280}}") # fit the 1000th data row in the converted spectrogram file. make sure the .srm file is in the same folder as the spectrogram file.
    ...
    fig.update_layout(width=600, yaxis_range = [-2,2])
